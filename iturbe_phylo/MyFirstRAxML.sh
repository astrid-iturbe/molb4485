...
raxmlHPC-PTHREADS-AVX -T 8  -f a -m GTRGAMMA -p 618 -N 50  -x 309 -s KnownBears.aln -n KnownBearTree -w /project/inbre-train/inbre010/molb4485/iturbe_phylo/BearTrees -o Giant-panda 
